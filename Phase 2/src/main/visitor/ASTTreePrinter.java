...
public class ASTTreePrinter extends Visitor<Void> {
    ...
    public Void visit(ConstructorDeclaration constructorDeclaration) {
        ...
        for (Statement i: constructorDeclaration.getBody()){
            i.accept(this);
        }
    ...
    public Void visit(MethodDeclaration methodDeclaration) {
        ...
        for (Statement i: methodDeclaration.getBody()){
            i.accept(this);
        }
        return null;
    }
    ...
    public Void visit(BlockStmt blockStmt) {
        ...
        for (Statement i: blockStmt.getStatements()){
            i.accept(this);
        }
        return null;
    }
    ...
    public Void visit(MethodCall methodCall) {
        ...
        for (Expression i: methodCall.getArgs()){
            i.accept(this);
        }
        return null;
    }
    ...
    public Void visit(NewClassInstance newClassInstance) {
        ...
        for (Expression i: newClassInstance.getArgs()){
            i.accept(this);
        }
        return null;
    }
    ...
    public Void visit(ListValue listValue) {
        ...
        for (Expression i: listValue.getElements()){
            i.accept(this);
        }
        return null;
    }
